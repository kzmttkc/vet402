...
export function encodeTransferCheckedData(amount: number | bigint, decimals: number): Uint8Array {
...
export function createSplTokenLite(web3: SolanaWeb3): SplTokenLite {
  ...
  return {
    ...
    createTransferCheckedInstruction(source, mint, destination, owner, amount, decimals, programId = TOKEN_PROGRAM_ID) {
      return new web3.TransactionInstruction({
        ...
        data: encodeTransferCheckedData(amount, decimals) as Web3.TransactionInstructionCtorFields["data"],
      });
    },
  };
}
