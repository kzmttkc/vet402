...
export { payOrRefuse, readDemoDecisions, readL1Decisions, appendDecision, DEFAULT_DECISION_STORE, BASE_CHAIN, BASE_CHAIN_ID, BASE_USDC, DEFAULT_MAX_PER_TX_USD, PAY_REFUSE_REASONS, SOLANA_MAINNET, SOLANA_USDC, svmAccountFromKeypair, type PayRail, type SvmPayOptions, type SvmPayerAccount, type SvmTransactionLike, type SvmKeypairLike, type PayOrRefuseBaseInput, type PayOrRefuseInput, type PayOrRefusePayeeInput, type PayOrRefuseNamedPayeeInput, type EnsGateInput, type PayEnsEvidence, type PayOrRefuseResult, type PayDecisionRecord, type PayPolicy, type PayEvidencePolicy, type PayEvidenceRow, type PayEvidenceSource, type PayRefuseReason, type PayerAccount, type X402Accept, type X402Settlement, type StoredDecision, type DecisionStoreOptions, type Eip3009Authorization, } from "./pay-or-refuse.js";
/**
 * 第2の証拠源（The Graph の x402 Base subgraph）。呼び手が自分の鍵で自分で引ける形で
 * 公開する——「あなたは vet402 を信じなくてよい」を、道具として渡せなければ主張にならない。
 */
export { readSubgraphReceipts, redactGraphKey, GRAPH_KEY_PLACEHOLDER, X402_BASE_SUBGRAPH_ID, GRAPH_GATEWAY_ORIGIN, GRAPH_USER_AGENT, DEFAULT_GRAPH_TIMEOUT_MS, type SubgraphReceipts, type SubgraphUnavailable, type SubgraphReadResult, type ReadSubgraphReceiptsInput, } from "./subgraph-evidence.js";
...
export type SellerFacts = {
    ...
    l1: {
         ...
         * 402 以外）か、vet402 自身の購入元ウォレットの資金切れ期間（2026-09-13〜15）の 402・5xx。n_attempts に
