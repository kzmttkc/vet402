...
④`/demo` **録り直し済み（2026-09-03・59.8秒）**——L0 pass 7,193・購入2,555の本番で再収録し、`/corrections` を1ショット追加。収録中に字幕と画面の食い違い3件を修正（受領証と言って宣言欄を映す／失敗と言って成功行を映す／Basescanの広告が画面内）。**宿題5件は全て完了**。
