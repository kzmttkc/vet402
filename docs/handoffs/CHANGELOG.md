...
## 2026-09-20 JST — L1 の支払い付き要求に、売り手が 402 で宣言したクエリを足す（既定 OFF・CAIP-2 の許可リスト・vet402.com コア・ブランチ `fix/xrpl-declared-query` 2 コミット・独立レビュー反映済み・push は依頼元）
