# A/B run — 2026-09-10T23:24:22.064Z
...
|---|---|---|---|---|---|---|---|---|
| A | 10 | 7 | 70% | 10 | 7 | 3 | 0 | 0 |
| B | 10 | 5 | 50% | 10 | 5 | 5 | 0 | 0 |

**delta (B − A)**: success -2 · successRate -20pt
...
Non-scoring: count under the ORIGINAL (pre-amendment) rule — A: 7, B: 5.
