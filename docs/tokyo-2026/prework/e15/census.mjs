import fs from 'fs';
import { viem, ABI, A, W_VET, W_ENS, RPC_S, RPC_P, dns, J, client, ALL_ROLES, RD } from './lib.mjs';
...
fs.writeFileSync(new URL('./census_result.json', import.meta.url), JSON.stringify(out, null, 1));
