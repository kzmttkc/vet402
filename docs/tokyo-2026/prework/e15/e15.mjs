import fs from 'fs';
import { viem, viemEns, viemVersion, sepolia as sepoliaChain, ABI, A, W_VET, W_ENS, W_OP, W_OP2, W_OBS, K_ATST, RPC_S, RPC_P, dns, J, client, pr, ALL_ROLES, ROLE_SET_TEXT, ROLE_LINK, RD, ATT_KEY, OBS_KEYS, decErr } from './lib.mjs';
...
fs.writeFileSync(new URL('./e15_result.json', import.meta.url), JSON.stringify(out, null, 1));
