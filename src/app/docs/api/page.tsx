...
type Endpoint = {
  method: "GET" | "POST";
  path: string;
  // 2026-09-07 ETHOnline (F13): a note may carry a link. Only /decision uses it, once.
  note: ReactNode;
  request?: string;
  response: string;
};
